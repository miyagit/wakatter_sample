...
ActiveRecord::Schema[7.0].define(version: 2025_06_04_020310) do
  ...
  create_table "message_room_users", charset: "utf8mb4", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "message_room_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["message_room_id"], name: "index_message_room_users_on_message_room_id"
    t.index ["user_id", "message_room_id"], name: "index_message_room_users_on_user_id_and_message_room_id", unique: true
    t.index ["user_id"], name: "index_message_room_users_on_user_id"
  end

  create_table "message_rooms", charset: "utf8mb4", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
